...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the HackOregon starter.
...
6.  **`gatsby-config.js`**: This is the main configuration file for a Gatsby site. This is where you can specify information about your site (metadata) like the site title and description, which Gatsby plugins you’d like to include, etc. We've added the required pieces for Hack Oregon's TravisCI pipeline.(Check out the [config docs](https://www.gatsbyjs.org/docs/gatsby-config/) for more detail).
